...
#include "../../../Launcher/MainWidget/SettingWidget/VersionWidget/VersionListView/VersionListView.h"
...
static const char qt_meta_stringdata_VersionListView[] = {
    "VersionListView\0"
};

const QMetaObject VersionListView::staticMetaObject = {
    { &CustomListView::staticMetaObject, qt_meta_stringdata_VersionListView,
      qt_meta_data_VersionListView, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VersionListView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VersionListView))
        return static_cast<void*>(const_cast< VersionListView*>(this));
