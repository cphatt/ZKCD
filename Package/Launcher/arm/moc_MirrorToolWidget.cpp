...
#include "../../../Launcher/MainWidget/LinkWidget/MirrorLinkWidget/MirrorToolWidget/MirrorToolWidget.h"
...
const QMetaObject MirrorToolWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MirrorToolWidget,
      qt_meta_data_MirrorToolWidget, 0 }
};
...
int MirrorToolWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: toolBtnRelease((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 1: onToolBtnRelease(); break;
        default: ;
        }
        _id -= 2;
    }
