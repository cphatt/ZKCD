...
public:
    ...
    SDDiskListViewWidget* m_SDDiskListViewWidget = NULL;
    SDDiskToolWidget* m_SDDiskToolWidget = NULL;
    MessageBox* m_SDDiskDeviceMessageBox = NULL;
    BmpWidget* m_SDDiskTip = NULL;
    bool m_RequestShow = false;
    bool m_Multimedia = false;
private:
    SDDiskWidget* m_Parent = NULL;
};
    ...
    case Widget::T_SDDisk: {
        if (WidgetStatus::RequestShow == status) {
            ...
            if (m_Private->m_Multimedia) {
                ...
                EventEngine::CustomEvent<int> event(CustomEventType::SDMultimediaType, NULL);
