...
#ifdef gcc
            painter.drawRect(m_Private->m_ToolButtonMap[static_cast<HomeWidgetPrivate::Type>(i)].touchRect);
#endif
...
void HomeWidgetPrivate::initialize()
{
    ...
    if (NULL == m_Background) {
        if (UserInterfaceUtility::loadFromdata(QString(":/Images/Resources/Images/HomeWidgetBackground.dat"), m_ByteArray)) {
            m_Background = new QImage((const uchar *)m_ByteArray.data(), 1280, 576, QImage::Format_RGB32);
        }
    }
    qWarning() << time.elapsed() << "-------2222";
    if (NULL == m_ToolButtonMap[HomeWidgetPrivate::T_SD].normalImage) {
        if (UserInterfaceUtility::loadFromdata(QString(":/Images/Resources/Images/HomeWidgetSDDiskNormall.dat"), m_ToolButtonMap[HomeWidgetPrivate::T_SD].byteArray)) {
            m_ToolButtonMap[HomeWidgetPrivate::T_SD].normalImage = new QImage((const uchar *)m_ToolButtonMap[HomeWidgetPrivate::T_SD].byteArray.data(), 82, 101, QImage::Format_ARGB32);
        }
    }
    if (NULL == m_ToolButtonMap[HomeWidgetPrivate::T_USB].normalImage) {
        if (UserInterfaceUtility::loadFromdata(QString(":/Images/Resources/Images/HomeWidgetSDDiskNormall.dat"), m_ToolButtonMap[HomeWidgetPrivate::T_USB].byteArray)) {
            m_ToolButtonMap[HomeWidgetPrivate::T_USB].normalImage = new QImage((const uchar *)m_ToolButtonMap[HomeWidgetPrivate::T_USB].byteArray.data(), 82, 101, QImage::Format_ARGB32);
        }
    }
//    if (m_ToolButtonMap[HomeWidgetPrivate::T_Link].normalImage->isNull()) {
//        m_ToolButtonMap[HomeWidgetPrivate::T_Link].normalImage->load(QString(":/Images/Resources/Images/HomeWidgetLinkNormall"));
//    }
    if (NULL == m_ToolButtonMap[HomeWidgetPrivate::T_Link].normalImage) {
        if (UserInterfaceUtility::loadFromdata(QString(":/Images/Resources/Images/HomeWidgetLinkNormall.dat"), m_ToolButtonMap[HomeWidgetPrivate::T_USB].byteArray)) {
            m_ToolButtonMap[HomeWidgetPrivate::T_Link].normalImage = new QImage((const uchar *)m_ToolButtonMap[HomeWidgetPrivate::T_Link].byteArray.data(), 124, 111, QImage::Format_ARGB32);
        }
    }
//    if (m_ToolButtonMap[HomeWidgetPrivate::T_AV1].normalImage->isNull()) {
//        m_ToolButtonMap[HomeWidgetPrivate::T_AV1].normalImage->load(QString(":/Images/Resources/Images/HomeWidgetAVNormall"));
//    }
    if (NULL == m_ToolButtonMap[HomeWidgetPrivate::T_AV1].normalImage) {
        if (UserInterfaceUtility::loadFromdata(QString(":/Images/Resources/Images/HomeWidgetAVNormall.dat"), m_ToolButtonMap[HomeWidgetPrivate::T_AV1].byteArray)) {
            m_ToolButtonMap[HomeWidgetPrivate::T_AV1].normalImage = new QImage((const uchar *)m_ToolButtonMap[HomeWidgetPrivate::T_AV1].byteArray.data(), 109, 109, QImage::Format_ARGB32);
        }
    }
//    if (m_ToolButtonMap[HomeWidgetPrivate::T_AV2].normalImage->isNull()) {
//        m_ToolButtonMap[HomeWidgetPrivate::T_AV2].normalImage->load(QString(":/Images/Resources/Images/HomeWidgetAVNormall"));
//    }
    if (NULL == m_ToolButtonMap[HomeWidgetPrivate::T_AV2].normalImage) {
        if (UserInterfaceUtility::loadFromdata(QString(":/Images/Resources/Images/HomeWidgetAVNormall.dat"), m_ToolButtonMap[HomeWidgetPrivate::T_AV2].byteArray)) {
            m_ToolButtonMap[HomeWidgetPrivate::T_AV2].normalImage = new QImage((const uchar *)m_ToolButtonMap[HomeWidgetPrivate::T_AV2].byteArray.data(), 109, 109, QImage::Format_ARGB32);
        }
    }
//    if (m_ToolButtonMap[HomeWidgetPrivate::T_Setting].normalImage->isNull()) {
//        m_ToolButtonMap[HomeWidgetPrivate::T_Setting].normalImage->load(QString(":/Images/Resources/Images/HomeWidgetSettingNormal"));
//    }
    if (NULL == m_ToolButtonMap[HomeWidgetPrivate::T_Setting].normalImage) {
        if (UserInterfaceUtility::loadFromdata(QString(":/Images/Resources/Images/HomeWidgetSettingNormal.dat"), m_ToolButtonMap[HomeWidgetPrivate::T_Setting].byteArray)) {
            m_ToolButtonMap[HomeWidgetPrivate::T_Setting].normalImage = new QImage((const uchar *)m_ToolButtonMap[HomeWidgetPrivate::T_Setting].byteArray.data(), 113, 113, QImage::Format_ARGB32);
        }
    }
