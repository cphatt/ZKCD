...
void AV2Widget::mousePressEvent(QMouseEvent *event)
{
...
{
    qDebug() << "AV2Widget::onAVStatus" << type << status;
    if (AVT_2 == type) {
...
void AV2WidgetPrivate::initializeTimer()
{
    if (NULL == m_Timer) {
...
void AV2WidgetPrivate::initializeShortCutWidget()
{
...
void AV2WidgetPrivate::initializeMessageBox()
{
